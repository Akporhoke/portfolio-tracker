...
function setupPullToRefresh() {
    ...
    document.addEventListener(
        ...
        e => {
            ...
            // Pull-to-refresh only works
            // when the page is at the very top.
            if (window.scrollY > 0) {
                pulling = false;
                return;
            }
    ...
    document.addEventListener(
        ...
        e => {
            ...
            // pull/bounce behavior once
            // our custom interaction activates.
            e.preventDefault();

            // Add resistance so the indicator
            // doesn't move exactly with the finger.
            const rawPull =
                distance -
                ACTIVATION_DISTANCE;
